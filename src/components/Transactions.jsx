  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full mt-3">
        ...
        />
        <div className="bg-[#8F00FF] p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
          <p className="text-[#00FFFF] font-bold">{timestamp}</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          <h3 className="text-white text-3xl text-center my-2">
            Most Recent Transactions Recorded
          </h3>
        ) : (
          <h3 className="text-white text-3xl text-center my-2">
            Connect your wallet to view the most recent transactions
          </h3>
        )}
